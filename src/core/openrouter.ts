...
function buildMessages(context: AgentTurnContext, mode: AgentExecutionMode) {
...
function parseToolAction(toolCall: {
  function?: {
    name?: string;
    arguments?: string;
  };
...
function parseJsonAction(content: string): AgentToolCall {
